...
public interface CameraPrx extends DevicePrx
{
    ...
    default CameraInfo getInfo()
    {
        return getInfo(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default CameraInfo getInfo(java.util.Map<String, String> context)
    {
        return _iceI_getInfoAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<CameraInfo> getInfoAsync()
    {
        return _iceI_getInfoAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<CameraInfo> getInfoAsync(java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<CameraInfo> _iceI_getInfoAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<CameraInfo> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getInfo", com.zeroc.Ice.OperationMode.Idempotent, sync, null);
        f.invoke(true, context, null, null, istr -> {
                     CameraInfo ret;
                     ret = CameraInfo.ice_read(istr);
                     return ret;
                 });
        return f;
    }

    default void setPosition(float pan, float tilt, float zoom)
        throws DeviceOffException,
               InvalidValueException
    {
        setPosition(pan, tilt, zoom, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void setPosition(float pan, float tilt, float zoom, java.util.Map<String, String> context)
        throws DeviceOffException,
               InvalidValueException
    {
        try
        {
            _iceI_setPositionAsync(pan, tilt, zoom, context, true).waitForResponseOrUserEx();
        }
    ...
    default java.util.concurrent.CompletableFuture<Void> setPositionAsync(float pan, float tilt, float zoom)
    {
        return _iceI_setPositionAsync(pan, tilt, zoom, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> setPositionAsync(float pan, float tilt, float zoom, java.util.Map<String, String> context)
    {
        return _iceI_setPositionAsync(pan, tilt, zoom, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_setPositionAsync(float iceP_pan, float iceP_tilt, float iceP_zoom, java.util.Map<String, String> context, boolean sync)
    {
        ...
        f.invoke(true, context, null, ostr -> {
                     ostr.writeFloat(iceP_pan);
                     ostr.writeFloat(iceP_tilt);
