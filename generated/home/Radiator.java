...
public interface Radiator extends Heater
{
    ...
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_setFanSpeed(Radiator obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
        throws com.zeroc.Ice.UserException
    {
        ...
        inS.endReadParams();
        obj.setFanSpeed(iceP_speed, current);
        ...
        throws com.zeroc.Ice.UserException
    {
        ...
        switch(pos)
        {
            ...
            case 7:
            {
                return _iceD_setFanSpeed(this, in, current);
            }
            case 8:
            {
