...
public class CalcI implements Calc {
	...
	public long add(int a, int b, Current __current) {
		String idStr = com.zeroc.Ice.Util.identityToString(__current.id);
		System.out.println("Logika wykonywana dla obiektu: " + idStr);
		System.out.println("Używam serwanta, który ma licznik: " + this.counter);
